-- This SQL command creates a stored procedure identical to the one created in the local folder of the GitHub repo (predict_and_write.py)
create or replace procedure predict_write_to_gold()
    returns String
    language python
    ...
    handler = 'predict_write_to_gold'
    as '# Imports and create a session
